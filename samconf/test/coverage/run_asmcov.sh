...
SOURCE_DIR=$BASE_DIR/samconf/src
BUILD_DIR=$(cd ${BUILD_DIR-$BASE_DIR/build/Debug} && pwd)
...
export LD_LIBRARY_PATH=${LD_LIBRARY_PATH-""}:$BUILD_DIR/src/libelos
export PATH=${PATH}:$BUILD_DIR/src/elosd/:$BUILD_DIR/src/demo/:$ASMCOV_DIR
