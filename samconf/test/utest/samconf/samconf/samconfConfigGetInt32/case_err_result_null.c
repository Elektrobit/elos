...
int samconfTestSamconfConfigGetInt32ErrorResultNullSetup(UNUSED void **state) {
    return 0;
}

int samconfTestSamconfConfigGetInt32ErrorResultNullTeardown(UNUSED void **state) {
    return 0;
}

void samconfTestSamconfConfigGetInt32ErrorResultNull(UNUSED void **state) {
    ...
    status = samconfConfigGetInt32(&root, testPath, NULL);
