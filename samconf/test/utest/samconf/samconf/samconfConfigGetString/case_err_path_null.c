...
int samconfTestSamconfConfigGetStringErrorPathNullSetup(UNUSED void **state) {
    return 0;
}

int samconfTestSamconfConfigGetStringErrorPathNullTeardown(UNUSED void **state) {
    return 0;
}

void samconfTestSamconfConfigGetStringErrorPathNull(UNUSED void **state) {
