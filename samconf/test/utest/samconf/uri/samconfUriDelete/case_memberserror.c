...
int samconfTestSamconfUriDeleteMembersErrorSetup(UNUSED void **state) {
    return 0;
}

int samconfTestSamconfUriDeleteMembersErrorTeardown(UNUSED void **state) {
    return 0;
}

void samconfTestSamconfUriDeleteMembersError(UNUSED void **state) {
    ...
    will_return(samconfUriDeleteMembers, SAMCONF_CONFIG_ERROR);
