...
int samconfTestSamconfSignatureLoaderGetSignatureForReadErrorSetup(UNUSED void **state) {
    return 0;
}

int samconfTestSamconfSignatureLoaderGetSignatureForReadErrorTeardown(UNUSED void **state) {
    return 0;
}

void samconfTestSamconfSignatureLoaderGetSignatureForReadError(UNUSED void **state) {
    ...
    will_set_parameter(__wrap_safuReadFileToString, string, NULL);
    will_return(__wrap_safuReadFileToString, -1);
