...
int samconfTestSamconfBase64DecodePaddingErrorSetup(UNUSED void **state) {
    return 0;
}

int samconfTestSamconfBase64DecodePaddingErrorTeardown(UNUSED void **state) {
    return 0;
}

void samconfTestSamconfBase64DecodePaddingError(UNUSED void **state) {
    ...
    SHOULD("%s", "issue an error for a base64 string with wrong padding");
