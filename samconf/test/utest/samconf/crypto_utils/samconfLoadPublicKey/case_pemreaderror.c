...
int samconfTestSamconfLoadPublicKeyPEMReadErrorSetup(UNUSED void **state) {
    return 0;
}

int samconfTestSamconfLoadPublicKeyPEMReadErrorTeardown(UNUSED void **state) {
    return 0;
}

void samconfTestSamconfLoadPublicKeyPEMReadError(UNUSED void **state) {
    ...
    will_return(__wrap_PEM_read_PUBKEY, NULL);
