...
int samconfTestSamconfJsonBackendLoadErrorFailedAddArraySetup(void **state) {
...
int samconfTestSamconfJsonBackendLoadErrorFailedAddArrayTeardown(void **state) {
...
void samconfTestSamconfJsonBackendLoadErrorFailedAddArray(void **state) {
    samconfJsonBackendLoadTestData_t *data = (samconfJsonBackendLoadTestData_t *)*state;
