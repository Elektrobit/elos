...
int elosTestElosMessageEventSubscribeResponseNewIntFailedSetup(void **state) {
...
int elosTestElosMessageEventSubscribeResponseNewIntFailedTeardown(void **state) {
...
void elosTestElosMessageEventSubscribeResponseNewIntFailed(void **state) {
    ...
    MOCK_FUNC_ALWAYS(safuJsonAddNewInt64);
    ...
    expect_any(__wrap_safuJsonAddNewInt64, jobj);
    expect_value(__wrap_safuJsonAddNewInt64, name, NULL);
    expect_value(__wrap_safuJsonAddNewInt64, val, queueId);
    will_return(__wrap_safuJsonAddNewInt64, NULL);
    ...
    expect_string(__wrap_safuLogFuncF, message, "safuJsonAddNewInt64 failed");
    ...
    expect_any(__wrap_safuLogFuncF, func);
    expect_any(__wrap_safuLogFuncF, line);
    expect_string(__wrap_safuLogFuncF, message, "failed to add eventqueueid to array");
    will_return(__wrap_safuLogFuncF, SAFU_LOG_STATUS_SUCCESS);
    ...
    MOCK_FUNC_NEVER(safuJsonAddNewInt64);
