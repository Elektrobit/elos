...
TEST_CASE_FUNC_PROTOTYPES(elosTestElosStorageManagerStopSuccess)
TEST_CASE_FUNC_PROTOTYPES(elosTestElosStorageManagerStopErrStorageManagerNull)
TEST_CASE_FUNC_PROTOTYPES(elosTestElosStorageManagerStopErrParamPluginManagerNull)
TEST_CASE_FUNC_PROTOTYPES(elosTestElosStorageManagerStopExtErrPluginManagerUnload)
