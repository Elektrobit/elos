...
int elosTestElosStorageManagerStartExtErrPluginManagerLoadSetup(void **state) {
...
int elosTestElosStorageManagerStartExtErrPluginManagerLoadTeardown(void **state) {
    elosUnitTestState_t *test = *(elosUnitTestState_t **)state;
...
void elosTestElosStorageManagerStartExtErrPluginManagerLoad(UNUSED void **state) {
    elosUnitTestState_t *test = *(elosUnitTestState_t **)state;
    safuResultE_t result = SAFU_RESULT_FAILED;
