...
int elosTestElosClientManagerThreadErrSemUnlock02Setup(void **state) {
...
int elosTestElosClientManagerThreadErrSemUnlock02Teardown(UNUSED void **state) {
    return 0;
}

void elosTestElosClientManagerThreadErrSemUnlock02(void **state) {
    elosClientManagerContext_t *context = *state;
    ...
    SHOULD("%s", "return SAFU_RESULT_FAILED when the second sem_post failed");
