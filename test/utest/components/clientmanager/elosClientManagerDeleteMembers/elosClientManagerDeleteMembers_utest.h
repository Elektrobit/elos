...
TEST_CASE_FUNC_PROTOTYPES(elosTestElosClientManagerDeleteMembersSuccess)
TEST_CASE_FUNC_PROTOTYPES(elosTestElosClientManagerDeleteMembersErrClientManagerNull)
TEST_CASE_FUNC_PROTOTYPES(elosTestElosClientManagerDeleteMembersErrParamPluginManagerNull)
TEST_CASE_FUNC_PROTOTYPES(elosTestElosClientManagerDeleteMembersExtErrPluginVectorFree)
