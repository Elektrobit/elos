...
TEST_CASE_FUNC_PROTOTYPES(elosTestElosClientManagerStartErrClientManagerNull)
TEST_CASE_FUNC_PROTOTYPES(elosTestElosClientManagerStartExtErrPluginManagerLoad)
