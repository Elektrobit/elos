...
int elosTestElosClientManagerStartExtErrPluginManagerLoadSetup(void **state) {
...
int elosTestElosClientManagerStartExtErrPluginManagerLoadTeardown(void **state) {
    elosUnitTestState_t *test = *(elosUnitTestState_t **)state;
...
void elosTestElosClientManagerStartExtErrPluginManagerLoad(UNUSED void **state) {
    elosUnitTestState_t *test = *(elosUnitTestState_t **)state;
    safuResultE_t result = SAFU_RESULT_FAILED;
