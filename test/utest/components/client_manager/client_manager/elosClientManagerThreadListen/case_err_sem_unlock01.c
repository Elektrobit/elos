...
int elosTestElosClientManagerThreadErrSemUnlock01Setup(void **state) {
...
int elosTestElosClientManagerThreadErrSemUnlock01Teardown(UNUSED void **state) {
    return 0;
}

void elosTestElosClientManagerThreadErrSemUnlock01(void **state) {
    elosClientManagerContext_t *context = *state;
    ...
    SHOULD("%s", "return SAFU_RESULT_FAILED when the first sem_post failed");
