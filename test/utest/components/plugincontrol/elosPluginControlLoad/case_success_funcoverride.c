...
int elosTestElosPluginControlLoadSuccessFuncOverrideSetup(void **state) {
...
int elosTestElosPluginControlLoadSuccessFuncOverrideTeardown(void **state) {
    elosUnitTestState_t *test = *(elosUnitTestState_t **)state;
    safuResultE_t result;
...
void elosTestElosPluginControlLoadSuccessFuncOverride(void **state) {
    elosUnitTestState_t *test = *(elosUnitTestState_t **)state;
    ...
    SHOULD("%s", "test correct behaviour of elosPluginControlLoad with function overloading");
    ...
    result = elosPluginControlLoad(&test->plugin);
    assert_int_equal(result, SAFU_RESULT_OK);
