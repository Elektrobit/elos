...
TEST_CASE_FUNC_PROTOTYPES(elosTestElosScannerManagerStopSuccess)
TEST_CASE_FUNC_PROTOTYPES(elosTestElosScannerManagerStopErrScannerManagerNull)
TEST_CASE_FUNC_PROTOTYPES(elosTestElosScannerManagerStopErrParamPluginManagerNull)
TEST_CASE_FUNC_PROTOTYPES(elosTestElosScannerManagerStopExtErrPluginManagerUnload)
