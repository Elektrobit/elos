...
TEST_CASE_FUNC_PROTOTYPES(elos_testElosRpnFilterBuilderCompileSuccessNumber)
TEST_CASE_FUNC_PROTOTYPES(elos_testElosRpnFilterBuilderCompileSuccessString)
TEST_CASE_FUNC_PROTOTYPES(elos_testElosRpnFilterBuilderCompileSuccess)
