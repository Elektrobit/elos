...
int elosTestEloEventFilterNodePushCreateFailedSetup(void **state) {
...
int elosTestEloEventFilterNodePushCreateFailedTeardown(void **state) {
...
void elosTestEloEventFilterNodePushCreateFailed(void **state) {
    elosTestState_t *test = *state;
    ...
    will_return(elosEventFilterCreate, SAFU_RESULT_FAILED);
    ...
    expect_string(__wrap_safuLogFuncF, message, "elosEventFilterCreate failed");
