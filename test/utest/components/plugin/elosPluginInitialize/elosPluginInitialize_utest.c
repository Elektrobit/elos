...
int main() {
    const struct CMUnitTest tests[] = {
        TEST_CASE(elosTestElosPluginInitializeErrFunc),
        TEST_CASE(elosTestElosPluginInitializeErrParam),
        TEST_CASE(elosTestElosPluginInitializeSuccessFuncOverride),
        TEST_CASE(elosTestElosPluginInitializeSuccess),
    };
