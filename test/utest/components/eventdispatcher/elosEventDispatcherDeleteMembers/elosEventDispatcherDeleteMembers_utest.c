...
int main() {
    const struct CMUnitTest tests[] = {
        TEST_CASE(testElosEventDispatcherDeleteMembersErrMutex),
        TEST_CASE(testElosEventDispatcherDeleteMembersErrParam),
        TEST_CASE(testElosEventDispatcherDeleteMembersSuccess),
    };
