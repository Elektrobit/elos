...
int main() {
    const struct CMUnitTest tests[] = {
        TEST_CASE(testElosEventDispatcherStartErrFunc),
        TEST_CASE(testElosEventDispatcherStartErrMutex),
        TEST_CASE(testElosEventDispatcherStartErrParam),
        TEST_CASE(testElosEventDispatcherStartSuccess),
    };
