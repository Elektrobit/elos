...
int elosTestElosClientManagerStopExtErrPluginManagerUnloadSetup(void **state) {
...
int elosTestElosClientManagerStopExtErrPluginManagerUnloadTeardown(void **state) {
    elosUnitTestState_t *test = *(elosUnitTestState_t **)state;
...
void elosTestElosClientManagerStopExtErrPluginManagerUnload(UNUSED void **state) {
    elosUnitTestState_t *test = *(elosUnitTestState_t **)state;
    safuResultE_t result = SAFU_RESULT_FAILED;
