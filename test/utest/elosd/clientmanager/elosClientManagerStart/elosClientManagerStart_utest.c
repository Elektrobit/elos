...
int main() {
    const struct CMUnitTest tests[] = {TEST_CASE(elosTestElosClientManagerStartSuccess),
                                       TEST_CASE(elosTestElosClientManagerStartErrClientManagerNull),
                                       TEST_CASE(elosTestElosClientManagerStartExtErrPluginManagerLoad)};
...
static int elosClientManagerStartUtestSetup(UNUSED void **state) {
...
static int elosClientManagerStartUtestTeardown(UNUSED void **state) {
    free(*state);
    *state = NULL;
