...
int elosTestElosStorageManagerStopSuccessSetup(void **state) {
...
int elosTestElosStorageManagerStopSuccessTeardown(void **state) {
    elosUnitTestState_t *test = *(elosUnitTestState_t **)state;
...
void elosTestElosStorageManagerStopSuccess(void **state) {
    elosUnitTestState_t *test = *(elosUnitTestState_t **)state;
    safuResultE_t result = SAFU_RESULT_FAILED;

    TEST("elosStorageManagerStop");
    SHOULD("stops storage manager succesfully");
