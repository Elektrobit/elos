...
*** Test Cases ***
01_Test_Complex_Blacklist_Filter
...
02_Test__Complex_Blacklist_Filter
...
Unauthorized Process Tries To Publish A Blacklisted Event
    ...
    ${rc}    Execute And Log    elosc -p '{"severity": 3,"classification": 260,"messageCode": 2010}'    ${RETURN_RC}
...
Unauthorized Process Tries To Publish A Normal Event
    ...
    ${rc}    Execute And Log    elosc -p '{"severity": 3,"classification": 260,"messageCode": 150}'    ${RETURN_RC}
...
Event Is Published
    ...
    ${stdout}    ${rc}   Execute And Log    elosc -f ".event.severity 3 EQ .event.messageCode 150 EQ AND"    ${RETURN_STDOUT}    ${RETURN_RC}
