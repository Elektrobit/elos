...
02_Test_Complex_Blacklist_Filter    # robocop: disable=not-capitalized-test-case-title
...
Unauthorized Process Tries To Publish A Blacklisted Event
    ...
    ${output}    ${error}     ${rc}
    ...                       Publish '{"severity": 3,"classification": 260,"messageCode": 2010}'
...
Unauthorized Process Tries To Publish A Normal Event
    ...
    ${output}    ${error}     ${rc}
    ...                       Publish '{"severity": 3,"classification": 260,"messageCode": 150}'
...
Event Is Published
    ...
    ${stdout}    ${stderror}    ${rc}
    ...          Find Events Matching '.event.severity 3 EQ .event.messageCode 150 EQ AND'
