...
int elosTestElosEventToJsonObjectSuccessSeverityOnlySetup(void **state) {
...
int elosTestElosEventToJsonObjectSuccessSeverityOnlyTeardown(void **state) {
...
void elosTestElosEventToJsonObjectSuccessSeverityOnly(void **state) {
    ...
    SHOULD("%s", "Convert the given event with only severity to corresponding json object");
