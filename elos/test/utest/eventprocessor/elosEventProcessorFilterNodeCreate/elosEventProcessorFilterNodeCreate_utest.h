...
TEST_CASE_FUNC_PROTOTYPES(elosTestEloEventProcessorFilterNodeCreateSuccess)
TEST_CASE_FUNC_PROTOTYPES(elosTestEloEventProcessorFilterNodeCreateErrParam)
TEST_CASE_FUNC_PROTOTYPES(elosTestEloEventProcessorFilterNodeCreateCreateFailed)
