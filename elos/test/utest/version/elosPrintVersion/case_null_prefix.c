...
void elosTestElosrintVersionNullPrefix(UNUSED void **state) {
    ...
    fprintf(expectedStream, "%u.%u.%u.%s", elosVersion.major, elosVersion.minor, elosVersion.micro, elosVersion.git);
    ...
    elosPrintVersion(currentStream, NULL);
