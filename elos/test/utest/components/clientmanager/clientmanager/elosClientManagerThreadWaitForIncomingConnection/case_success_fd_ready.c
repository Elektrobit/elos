...
int elosTestElosClientManagerThreadWaitForIncomingConnectionSuccessFdReadySetup(void **state) {
...
int elosTestElosClientManagerThreadWaitForIncomingConnectionSuccessFdReadyTeardown(UNUSED void **state) {
    return 0;
}

void elosTestElosClientManagerThreadWaitForIncomingConnectionSuccessFdReady(void **state) {
    elosClientManagerContext_t *context = *state;
