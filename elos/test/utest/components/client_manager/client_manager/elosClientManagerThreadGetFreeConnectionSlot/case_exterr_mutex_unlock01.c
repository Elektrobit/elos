...
int elosTestElosClientManagerThreadGetFreeConnectionSlotExtErrMutexUnlock01Setup(void **state) {
    elosClientManagerContext_t *context = *state;
    memset(context, '\0', sizeof(elosClientManagerContext_t));
    return 0;
}

int elosTestElosClientManagerThreadGetFreeConnectionSlotExtErrMutexUnlock01Teardown(UNUSED void **state) {
    return 0;
}

void elosTestElosClientManagerThreadGetFreeConnectionSlotExtErrMutexUnlock01(void **state) {
    elosClientManagerContext_t *context = *state;
