...
int elosTestElosPluginInitializeSuccessFuncOverrideSetup(UNUSED void **state) {
    return 0;
}

int elosTestElosPluginInitializeSuccessFuncOverrideTeardown(void **state) {
...
void elosTestElosPluginInitializeSuccessFuncOverride(void **state) {
    elosUnitTestState_t *test = *(elosUnitTestState_t **)state;
    ...
    SHOULD("%s", "test correct behaviour of elosPluginInitialize with function overloading");
