...
int main() {
    const struct CMUnitTest tests[] = {
        TEST_CASE(elosTestElosEventVectorSerializeErrConversion),
        TEST_CASE(elosTestElosEventVectorSerializeErrParam),
        TEST_CASE(elosTestElosEventVectorSerializeSuccess),
    };
