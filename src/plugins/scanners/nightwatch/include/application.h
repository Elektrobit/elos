...
private:
   ...
   */
  void createElosEvent(const std::string &message,
...
public:
   ...
   */
  Application(elosPlugin_t *plugin, elosPublisher *publisher, std::string name,
              Thresholds thresholds, unsigned long maxMemUsage,
              double maxCpuLoad);
