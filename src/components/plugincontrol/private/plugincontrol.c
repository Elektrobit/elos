...
safuResultE_t elosPluginControlFindEvents(elosPluginControl_t *pluginControl, const char *rule, struct timespec newest, struct timespec oldest, safuVec_t *events) {
    safuResultE_t result = SAFU_RESULT_FAILED;
